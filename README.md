...
Module 4 contains a bug that was corrected in Module 5. The ability to exit the application does not work correctly. However The exiting bug works properly in module 5.
